...
#Тест 2
#Напиши второй тест: test_create_user_15_letter_in_first_name_get_success_response(). Запусти его и убедись, что он пройден.
...
# Тест 5. Успешное создание
def test_create_user_english_letter_in_first_name_get_success_response():
    positive_assert("English")

# Тест 6. Успешное создание
...
def negative_assert_no_first_name(user_body):
    ...
    # Проверяется, что в ответе есть атрибут code - 400
    assert response.json()["code"] == 400
    #Проверяет, что в теле ответа атрибут message
